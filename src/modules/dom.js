...
export const DomElements = (() => {
  ...
  const updateData = (data, cel) => {
    ...
    if (data.main.toLowerCase() === 'clouds') {
      ...
      body.style.backgroundImage = 'url(https://imagevars.gulfnews.com/2019/10/05/Rain-UAE-0001_16d9a15da21_large.jpg)';
      ...
      body.style.backgroundImage = 'url(https://www.washingtonpost.com/resizer/ZVTyaknssC3yXxy2zWKyvRXkJA0=/1484x0/arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/OMPC2AQTQEI6VESMWNGQTO6JJA.jpg)';
    } else {
      body.style.backgroundImage = 'url(https://4.bp.blogspot.com/_tOJ-lqBX0wQ/TKzHK2u3PmI/AAAAAAAAAD0/yBauow-LYT4/s1600/Kayla+October+4+012.jpg)';
    }
